...
class BufferMemory(MemoryBase):
    ...
    Different sessions have independent message buffers and locks,
    satisfying the EventBus guarantee of same-session serial and
    cross-session parallel dispatch.
    """
    ...
    def _append(self, session_id: str, msg: BaseMessage) -> None:
